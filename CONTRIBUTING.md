...
pnpm add --save-dev tablemark-cli@canary
```

```sh
# install specific `canary` version
pnpm add --save-dev tablemark-cli@5.0.0-canary.1
```
...
> The [Release workflow](https://github.com/haltcase/tablemark-cli/actions/workflows/release.yml)
...
https://github.com/haltcase/tablemark-cli/blob/-/commitlint.config.ts
